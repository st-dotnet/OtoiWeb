...
var Portal = React.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React.isValidElement(children2) ? getReactElementRef(children2) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React.isValidElement(children2)) {
      ...
      return React.cloneElement(children2, newProps);
    }
...
//# sourceMappingURL=chunk-4MERN5E6.js.map
